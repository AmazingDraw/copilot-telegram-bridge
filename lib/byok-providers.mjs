...
const STRUCTURAL_DEFAULTS = {
    ...
    defaults: {
        ...
        claudeDefaultModel: "cliproxy/gemini-flash",
    },
    display: {
        officialModels: {
            enabled: true,
...
export function normalizeModelsConfig(raw) {
    ...
    return {
        ...
        paths: {
            ...
            claudeAgentsDir: resolveConfigPath(pathsIn.claudeAgentsDir || ""),
            claudeSessionDir: resolveConfigPath(pathsIn.claudeSessionDir || ""),
            claudeStateDir: resolveConfigPath(pathsIn.claudeStateDir || ""),
        },
