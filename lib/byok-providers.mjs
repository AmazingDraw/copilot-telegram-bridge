...
/**
 * Headless customize 默认裁剪。
 * 不 remove `identity` 组（会连带拆掉 tone / tool_efficiency）；只拆 CLI 身份与语气，保留改码/工具骨架。
 * 人设走 systemMessage.content，挂在全部 section 之后，避免被 last_instructions 盖掉。
 */
