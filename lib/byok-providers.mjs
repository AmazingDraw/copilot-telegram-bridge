...
const STRUCTURAL_DEFAULTS = {
    ...
    defaults: {
        ...
        claudeModelPrefix: "cliproxy/",
        claudeHaikuModel: "cliproxy/gemini-flash",
        claudeSmallFastModel: "cliproxy/gemini-flash",
    },
    display: {
        officialModels: {
            enabled: true,
...
export function normalizeModelsConfig(raw) {
    ...
    const claudeModelPrefix = String(defaultsIn.claudeModelPrefix || STRUCTURAL_DEFAULTS.defaults.claudeModelPrefix || "cliproxy/").trim();
...
/** /codex 与 /claude 共用的 CLI 模型菜单。不含 OpenCodex `[1m]` 长上下文分身。 */
