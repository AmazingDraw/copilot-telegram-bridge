...
import { loadModelsConfig, listConfiguredCliModelSlugs, parseCliproxyYaml, resolveConfigPath } from "./byok-providers.mjs";
...
function loadClaudePersonaText(claudeDir) {
    const p = join(claudeDir || join(process.env.HOME || "", ".claude"), "CLAUDE.md");
    try {
...
export function attachClaudeCommands(ctx) {
    ...
    function launchClaudeTask(chatId, task, prompt, imagePath = "") {
        return new Promise((resolve) => {
            ...
            const persona = loadClaudePersonaText(CLAUDE_DIR);
